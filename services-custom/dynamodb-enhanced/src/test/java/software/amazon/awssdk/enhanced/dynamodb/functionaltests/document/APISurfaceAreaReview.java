...
public class APISurfaceAreaReview extends LocalDynamoDbSyncTestBase {
    ...
    @Test
    public void enhancedDocDefaultSimpleAttributes() {
        /**
        ...
        assertThat(Double.valueOf(simpleDoc.getNumber("numberKey").doubleValue()).compareTo(2.0)).isEqualTo(0);
    ...
    @Test
    public void generic_access_to_enhancedDcoument_attributes() {
        ...
        assertThat(customDoc.toJson()).isEqualTo("{\"direct_attr\":\"sample_value\",\"custom_attr\":{\"longNumber\":25,"
                                                 + "\"string\":\"str\"},\"custom_list\":[{\"longNumber\":26,"
                                                 + "\"string\":\"str_one\"},{\"longNumber\":27,\"string\":\"str_two\"}]}");
     ...
     */
    @Test
    public void attributeConverter_Not_Added(){
    ...
    @Test
    public void putSimpleDocumentWithSimpleValues() {
    ...
    public void testV1(){
        ...
        TestData allSimpleTypes = EnhancedDocumentTestData.testDataInstance().dataForScenario("allSimpleTypes");

        // Item item = Item.fromJSON(allSimpleTypes.getJson());
        // EnhancedDocument enhancedDocument = EnhancedDocument.fromJson(allSimpleTypes.getJson());
        // System.out.println("item " +item.toJSON());
        // System.out.println("enhancedDocument " +enhancedDocument.toJson());
        // assertThat(item.toJSON()).isEqualTo(enhancedDocument.toJson());


        //
        // Item item2 = new Item().with("string", String.valueOf(c));
        // System.out.println(enhancedDocument.toJson());

        // Item item = Item.fromJSON(allSimpleTypes.getJson());
        EnhancedDocument enhancedDocument = EnhancedDocument.fromJson(allSimpleTypes.getJson());
        System.out.println("item " +enhancedDocument.toJson());

        // boolean some = Item.fromJSON("{}").getBOOL("");
        ...
        System.out.println("item "+ Item.fromJSON(allSimpleTypes.getJson()).toJSON());


        char c = 0x0a;

        EnhancedDocument enhancedDocumentEsc = EnhancedDocument.builder()
                                                            .attributeConverterProviders(defaultProvider())
                                                            .putString("s",String.valueOf(c) ).build();


        System.out.println(enhancedDocumentEsc.toJson());
        Item item2 = new Item().with("string", String.valueOf(c));
        ...
        EnhancedDocument enhancedDocumentEsc2 = EnhancedDocument.builder()
                                                               .attributeConverterProviders(defaultProvider())
                                                               .putString("s","\\n" ).build();


        System.out.println(enhancedDocumentEsc2.toJson());
        Item item22 = new Item().with("string", "\\n");

        System.out.println(item22.toJSON());
